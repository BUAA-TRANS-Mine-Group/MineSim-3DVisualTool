...
class Visualizer {
  ...
  private:
    void VisualizeVehicleSet(const ros::Time &stamp, const common::VehicleSet &vehicle_set);
    void VisualizeLaneNet(const ros::Time &stamp, const common::LaneNet &lane_net);
    void VisualizeObstacleSet(const ros::Time &stamp, const common::ObstacleSet &Obstacle_set);
