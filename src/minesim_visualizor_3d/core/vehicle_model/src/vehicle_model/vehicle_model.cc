...
VehicleModel::VehicleModel(double wheelbase_len, double max_steering_angle) : wheelbase_len_(wheelbase_len), max_steering_angle_(max_steering_angle) {
    UpdateInternalState();
}
...
void VehicleModel::operator()(const InternalState &x, InternalState &dxdt, const double /* t */) {
    State cur_state;
