...
namespace control {
ErrorType IntelligentVelocityControl::CalculateDesiredVelocity(const simulator::IntelligentDriverModel::Param &param, const decimal_t s,
    ...
    state.s = s;
    state.v = std::max(0.0, v); // negative velocity may cause integration unbounded
