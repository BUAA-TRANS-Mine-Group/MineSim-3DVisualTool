...
class RosAdapter {
  ...
  private:
    ...
    void ArenaInfoStaticCallback(const vehicle_msgs::ArenaInfoStatic::ConstPtr &msg);
    void ArenaInfoDynamicCallback(const vehicle_msgs::ArenaInfoDynamic::ConstPtr &msg);
