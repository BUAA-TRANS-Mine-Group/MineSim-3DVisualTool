...
class VisualizationUtil {
  public:
    ...
    static ErrorType GetMarkerByPolynomial(const PolynomialND<N_DEG, N_DIM> &poly, const decimal_t s0, const decimal_t s1, const decimal_t step,
                                           const Vec3f scale, const ColorARGB color, visualization_msgs::Marker *marker) {
     ...
     */
    template <int N_DEG, int N_DIM>
    static ErrorType GetMarkerBySpline(const Spline<N_DEG, N_DIM> &spline, const decimal_t step, const Vec3f &scale, const ColorARGB &color,
     ...
     * @return ErrorType
     */
    static ErrorType GetMarkerByLane(const Lane &lane, const decimal_t step, const Vec3f &scale, const ColorARGB &color, const decimal_t offset_z,
     ...
     * @return ErrorType
     */
    static ErrorType GetMarkerArrayByTrajectory(const Trajectory &traj, const decimal_t step, const Vec3f &scale, const ColorARGB &color,
                                                const decimal_t offset_z, visualization_msgs::MarkerArray *marker_arr) {
        if (!traj.IsValid())
            return kIllegalInput;
     ...
     * @return ErrorType
     */
    template <int N_DIM> static ErrorType ConvertVectorToPoint32(const Vecf<N_DIM> &vec, geometry_msgs::Point32 *point) {
        point->x = 0.0;
        point->y = 0.0;
        point->z = 0.0;
     ...
     * @return ErrorType
     */
    static ErrorType GetMarkerArrayByStateVector(const vec_E<State> &state_vec, const ColorARGB &color, visualization_msgs::MarkerArray *marker_arr) {
        visualization_msgs::Marker traj_mk;
        traj_mk.type = visualization_msgs::Marker::LINE_STRIP;
        traj_mk.action = visualization_msgs::Marker::MODIFY;
     ...
     * @return ErrorType
     */
    static ErrorType FillScaleColorInMarker(const Vec3f scale, const ColorARGB color, visualization_msgs::Marker *marker) {
     ...
     * @return ErrorType
     */
    static ErrorType FillHeaderIdInMarkerArray(const ros::Time time_stamp, const std::string frame_id, const int last_array_size,
     ...
     * @return ErrorType
     */
    static ErrorType FillLifeTimeInMarkerArray(const ros::Duration duration, visualization_msgs::MarkerArray *marker_arr) {
        for (auto &mk : marker_arr->markers) {
     ...
     * @return ErrorType
     */
    static ErrorType GetRosPoseArrayFromState3dVector(const std::vector<Vec3f> &states, geometry_msgs::PoseArray *p_pose_array) {
     ...
     * @return ErrorType
     */
    static ErrorType GetRosPointCloudFrom3DofStateVector(const std::vector<Vec3f> &states, sensor_msgs::PointCloud *p_pc) {
     ...
     * @return ErrorType
     */
    static ErrorType GetRosPointCloudFromCircleArcBranch(const CircleArcBranch &arc_branch, sensor_msgs::PointCloud *p_pc) {
        p_pc->header.frame_id = "map";
        p_pc->header.stamp = ros::Time::now();
     ...
     * @return ErrorType
     */
    static ErrorType GetRosPointCloudFromPointList(const std::vector<common::Point> &point_list, sensor_msgs::PointCloud *p_pc) {
        p_pc->header.frame_id = "map";
        p_pc->header.stamp = ros::Time::now();
     ...
     * @return ErrorType
     */
    static ErrorType GetRosMarkerSphereUsingPoint(const Vec3f &pt, const ColorARGB &color, const Vec3f &scale, const int &id,
     ...
     * @return ErrorType
     */
    static ErrorType GetRosMarkerCylinderUsingPoint(const Point &pt, const Vec3f &scale, const ColorARGB &color, const int &id,
                                                    visualization_msgs::Marker *p_marker) {
        p_marker->type = visualization_msgs::Marker::CYLINDER;
        p_marker->action = visualization_msgs::Marker::MODIFY;
        p_marker->id = id;
     ...
     * @return ErrorType
     */
    static ErrorType GetRosMarkerCubeUsingOrientedBoundingBox2D(const OrientedBoundingBox2D &obb, const ColorARGB &color, const decimal_t &scale_z,
                                                                visualization_msgs::Marker *p_marker) {
     ...
     * @return ErrorType
     */
    static ErrorType GetRosMarkerCubeUsingOrientedBoundingBox2DWithOffsetZ(const OrientedBoundingBox2D &obb, const decimal_t offset_z,
     ...
     * @return ErrorType
     */
    static ErrorType GetRosMarkerCubeUsingAxisAlignedBoundingBox3D(const AxisAlignedBoundingBoxND<3> &aabb, const ColorARGB &color,
                                                                   visualization_msgs::Marker *p_marker) {
        p_marker->type = visualization_msgs::Marker::CUBE;
        p_marker->action = visualization_msgs::Marker::MODIFY;
     ...
     * @return ErrorType
     */
    static ErrorType GetRosMarkerCubeUsingAxisAlignedCube3D(const AxisAlignedCubeNd<int, 3> &aabb, const ColorARGB &color,
                                                            visualization_msgs::Marker *p_marker) {
        p_marker->type = visualization_msgs::Marker::CUBE;
        p_marker->action = visualization_msgs::Marker::MODIFY;
     ...
     * @return ErrorType
     */
    static ErrorType GetRosMarkerMeshUsingOrientedBoundingBox2D(const OrientedBoundingBox2D &obb, const ColorARGB &color,
                                                                visualization_msgs::Marker *p_marker) {
        ...
        quaternionTFToMsg(tf::Quaternion(obb_pose.orientation.x, obb_pose.orientation.y, obb_pose.orientation.z, obb_pose.orientation.w) * q,
     ...
     * @return ErrorType
     */
    static ErrorType GetRosMarkerMeshHexagonSignUsingPosition(const Vec3f &state, const decimal_t &z_offset, const ColorARGB &color, const int &id,
                                                              visualization_msgs::Marker *p_marker) {
        p_marker->header.frame_id = "map";
        p_marker->header.stamp = ros::Time::now();
        p_marker->id = id;
    ...
    static ErrorType GetRosMarkerArrowUsingOriginAndVector(const Vec3f &origin, const Vec3f &vec, visualization_msgs::Marker *p_mk) {
     ...
     * @return ErrorType
     */
    static ErrorType GetRosMarkerArrowUsingPoseAndNorm(const geometry_msgs::Pose &pose, const double &norm, const ColorARGB &color,
                                                       visualization_msgs::Marker *p_marker) {
     ...
     * @return ErrorType
     */
    static ErrorType GetRosMarkerLineStripUsing2DofVec(const vec_E<Vec2f> &path, const ColorARGB &color, const Vec3f &scale, const int &id,
                                                       visualization_msgs::Marker *p_marker) {
     ...
     *
     * ### 车道线条宽度设置的部分
     * - `p_marker->scale.x = scale(0);` 和 `p_marker->scale.y = scale(1);` 设置了车道线条的宽度。这两个属性控制了绘制的线条的粗细。
     * - `scale.x` 和 `scale.y` 对应了线条的**宽度**（X轴和Y轴方向）。通常来说，`scale.x` 控制着水平宽度，`scale.y` 控制着垂直宽度。
     * - `scale.z` 则控制了线条的深度（通常用于控制线条的厚度，但在大多数情况下，它的影响较小，通常会被设置为1或其他默认值）。
     * ### 示例：
     *  在调用 `GetRosMarkerLineStripUsing2DofVecWithOffsetZ` 时，传入的 `scale` 是一个 `Vec3f`
     * 类型的对象，它包含了三个浮动值，分别控制X、Y、Z轴的缩放。 假设 `scale` 被设置为 `Vec3f(0.1, 0.1, 0.0)`，那么：
     *   - `scale.x = 0.1` 会影响车道线的宽度（X轴方向）。
     *   - `scale.y = 0.1` 会影响车道线的宽度（Y轴方向）。
     *   - `scale.z = 0.0` 对线条的厚度没有影响，因为通常Z轴设置为0或其他较小的值来表示线条的“深度”或厚度。
     *
     */
    static ErrorType GetRosMarkerLineStripUsing2DofVecWithOffsetZ(const vec_E<Vec2f> &path, const ColorARGB &color, const Vec3f &scale,
                                                                  const std::vector<decimal_t> &z, const int &id,
                                                                  visualization_msgs::Marker *p_marker) {
        p_marker->type = visualization_msgs::Marker::LINE_STRIP; // 设置marker类型为LINE_STRIP，表示绘制一系列连接点的线
        p_marker->action = visualization_msgs::Marker::MODIFY;   // 修改现有的marker
        p_marker->id = id;                                       // 设置marker的ID
        ...
        // 遍历path中的所有点，并将其添加到marker的points中
        for (int i = 0; i < path.size(); ++i) {
            geometry_msgs::Point pt;
            pt.x = path[i](0);
            pt.y = path[i](1);
            pt.z = z[i]; // 设置点的z坐标（可能是车道线的高度）
            p_marker->points.push_back(pt);
        }

        FillColorInMarker(color, p_marker); // 为marker填充颜色
        p_marker->scale.x = scale(0);       // 设置车道线的宽度（X轴方向）
        p_marker->scale.y = scale(1);       // 车道线的宽度（Y轴方向）
        p_marker->scale.z = scale(2); // 设置深度（Z轴方向），通常用于调整线条的厚度，但通常车道线宽度设置在X、Y轴上
     ...
     * @return ErrorType
     */
    static ErrorType GetRosMarkerLineStripUsing3DofStateVec(const std::vector<Vec3f> &path, const decimal_t z_offset, const ColorARGB &color,
     ...
     * @return ErrorType
     */
    static ErrorType GetRosMarkerTextUsingPositionAndString(const Vec3f &pos, const std::string &str, const ColorARGB &color, const Vec3f &scale,
     ...
     * @return ErrorType
     */
    static ErrorType GetRosMarkerLineStripGradientColorUsing3DofStateVec(const std::vector<Vec3f> &path, const Vec3f &scale,
     ...
     * @return ErrorType
     */
    static ErrorType GetRosMarkerLineStripUsingPoints(const std::vector<Point> points, const Vec3f &scale, const ColorARGB &color, const int &id,
                                                      visualization_msgs::Marker *p_marker) {
        p_marker->type = visualization_msgs::Marker::LINE_STRIP;
        p_marker->action = visualization_msgs::Marker::MODIFY;
        p_marker->id = id;
     ...
     * @return ErrorType
     */
    static ErrorType GetRosMarkerArrayUsingVehicle(const Vehicle &vehicle, const ColorARGB &color_obb, const ColorARGB &color_vel_vec,
                                                   const ColorARGB &color_steer, const int &id, visualization_msgs::MarkerArray *p_marker_array) {
        ...
        GetRosMarkerTextUsingPositionAndString(pos, str, cmap.at("black"), Vec3f(0.75, 0.75, 0.75), id + 3, &vel_text_marker);
        ...
        GetRosMarkerLineStripUsing3DofStateVec(arc_samples, +0.2, color_steer, Vec3f(0.1, 0, 0), id + 4, &steering_angle_marker);
        ...
        GetRosMarkerLineStripUsing3DofStateVec(arc_samples2, +0.2, color_steer, Vec3f(0.1, 0, 0), id + 5, &steering_angle_marker_reverse);
        ...
        horizontal_line.emplace_back(state3df[0] + line_width * sin(state3df[2]), state3df[1] - line_width * cos(state3df[2]), -0.2);
        horizontal_line.emplace_back(state3df[0] - line_width * sin(state3df[2]), state3df[1] + line_width * cos(state3df[2]), -0.2);
        GetRosMarkerLineStripUsing3DofStateVec(horizontal_line, -0.4, color_steer, Vec3f(0.1, 0, 0), id + 6, &horizontal_marker);
     ...
     * @return ErrorType
     */
    static ErrorType GetRosMarkerUsingPolygonObstacle(const PolygonObstacle &obs, const int &id, visualization_msgs::Marker *p_marker) {
        std::vector<Point> points = obs.polygon.points;
        std::vector<decimal_t> heights = obs.polygon.heights;
        // points.push_back(*(points.begin())); //将points数组中的第一个点坐标添加到数组的末尾，从而将线段的起点和终点连接起来
        int cnt = 0;
        for (auto &p : points) {
            p.z = heights[cnt];
            ++cnt;
        ...
        // 矿区道路 边界线 border line
        GetRosMarkerLineStripUsingPoints(points, common::object_scale_map_minesim.at("border_line"), common::color_map_minesim.at("border_line"), id,
                                         p_marker);
        return kSuccess;
    }
     ...
     * @return ErrorType
     */
    static ErrorType GetRosMarkerUsingObstacleSet(const ObstacleSet &obstacles, visualization_msgs::MarkerArray *p_marker_array) {
     ...
     * @return ErrorType
     */
    static ErrorType GetRosMarkerArrUsingSemanticBehavior(const SemanticBehavior &behavior, visualization_msgs::MarkerArray *p_marker_array) {
            ...
            for (const auto &surround_trajs : surround_trajs_set) {
                for (const auto &p_traj : surround_trajs) {
                    ...
                    for (const auto &v : p_traj.second) {
                        ...
                        common::VisualizationUtil::GetRosMarkerCylinderUsingPoint(common::Point(pt), Vec3f(0.5, 0.5, 0.1), traj_color, ++cnt,
                                                                                  &point_marker);
                    ...
                    common::VisualizationUtil::GetRosMarkerLineStripUsingPoints(points, Vec3f(0.1, 0.1, 0.1), traj_color, ++cnt, &line_marker);
     ...
     */
    template <typename T>
    static ErrorType GetRosMarkerCubeListUsingGripMap3D(const GridMapND<T, 3> *p_grid_map, const ros::Time &time_stamp, const std::string &frame_id,
                                                        const Vec3f &pose, visualization_msgs::Marker *p_marker) {
