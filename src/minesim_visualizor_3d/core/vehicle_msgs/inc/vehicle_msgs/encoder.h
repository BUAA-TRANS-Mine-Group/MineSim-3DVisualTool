...
class Encoder {
  public:
    static ErrorType GetRosFreeStateMsgFromFreeState(const common::FreeState &in_state, const ros::Time &timestamp, vehicle_msgs::FreeState *state) {
    ...
    static ErrorType GetRosStateMsgFromState(const common::State &in_state, const ros::Time &timestamp, vehicle_msgs::State *state) {
        state->header.stamp = timestamp;
        state->header.frame_id = std::string("map");
    ...
    static ErrorType GetRosVehicleSetFromVehicleSet(const common::VehicleSet &vehicle_set, const ros::Time &timestamp, const std::string &frame_id,
                                                    vehicle_msgs::VehicleSet *msg) {
    ...
    static ErrorType GetRosVehicleFromVehicle(const common::Vehicle &vehicle, const ros::Time &timestamp, const std::string &frame_id,
    ...
    static ErrorType GetRosVehicleParamFromVehicleParam(const common::VehicleParam &vehicle_param, vehicle_msgs::VehicleParam *msg) {
    ...
    static ErrorType GetRosLaneNetFromLaneNet(const common::LaneNet &lane_net, const ros::Time &timestamp, const std::string &frame_id,
    ...
    static ErrorType GetRosLaneFromLaneRaw(const common::LaneRaw &lane, const ros::Time &timestamp, const std::string &frame_id,
    ...
    static ErrorType GetRosObstacleSetFromObstacleSet(const common::ObstacleSet &obstacle_set, const ros::Time &timestamp,
    ...
    static ErrorType GetRosCircleObstacleFromCircleObstacle(const common::CircleObstacle &circle, const ros::Time &timestamp,
    ...
    static ErrorType GetRosPolygonObstacleFromPolygonObstacle(const common::PolygonObstacle &poly, const ros::Time &timestamp,
    ...
    static ErrorType GetRosArenaInfoFromSimulatorData(const common::LaneNet &lane_net, const common::VehicleSet &vehicle_set,
    ...
    static ErrorType GetRosArenaInfoStaticFromSimulatorData(const common::LaneNet &lane_net, const common::ObstacleSet &obstacle_set,
    ...
    static ErrorType GetRosArenaInfoDynamicFromSimulatorData(const common::VehicleSet &vehicle_set, const ros::Time &timestamp,
    ...
    static ErrorType GetRosControlSignalFromControlSignal(const common::VehicleControlSignal &ctrl, const ros::Time &timestamp,
