...
struct ColorARGB {
    ...
    decimal_t g;
    decimal_t b;
    ColorARGB(decimal_t A, decimal_t R, decimal_t G, decimal_t B) : a(A), r(R), g(G), b(B) {}
...
extern std::map<std::string, ColorARGB> color_map_minesim;
extern std::map<std::string, Vec3f> object_scale_map_minesim;
 ...
 * @return ColorARGB color
 */
ColorARGB GetJetColorByValue(const decimal_t val, const decimal_t max, const decimal_t min);
} // namespace common
