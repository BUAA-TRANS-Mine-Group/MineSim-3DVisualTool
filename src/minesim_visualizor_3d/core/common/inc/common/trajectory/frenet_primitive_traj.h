...
class FrenetPrimitiveTrajectory : public FrenetTrajectory {
  public:
    ...
    FrenetPrimitiveTrajectory(const FrenetPrimitive &primitive, const StateTransformer &stf) : primitive_(primitive), stf_(stf), is_valid_(true) {}
    ...
    virtual void Jerk(decimal_t *j_lon, decimal_t *j_lat) const override { primitive_.GetJ(j_lon, j_lat); }
